...
//				Debug.Log ("In FixedUpdate - input received: " + input.ToString ());
//			}
...
//                desiredMove = Vector3.ProjectOnPlane(desiredMove, m_GroundContactNormal).normalized;
				...
				// Don't enforce movement along a plane
				//TODO: remove
				//Vector3 desiredMove = cam.transform.forward*input.y + cam.transform.right*input.x;
				...
				//TODO: REMOVE
//				Debug.Log ("In FixedUpdate - desiredMove: " + desiredMove.ToString ());
...
//			if (brakeAmt > 0.0) {
//				Debug.Log ("Brake amt: " + brakeAmt.ToString ());
//			}
...
//			if (input != Vector2.zero) {
//				Debug.Log ("Input received: " + input.ToString ());
//			}
